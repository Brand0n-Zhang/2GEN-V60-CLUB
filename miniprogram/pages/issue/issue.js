...
Page({
    ...
    seriesChange: function (e) {
        ...
        if (currentSeries === '全部') {
            ...
            for (var _i = 0, _a = this.data.issueList; _i < _a.length; _i++) {
                var item = _a[_i];
